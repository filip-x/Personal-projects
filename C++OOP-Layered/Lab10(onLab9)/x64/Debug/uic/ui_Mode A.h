...
public:
    ...
    void setupUi(QWidget *ModeAForm)
    {
        ...
        undo_button = new QPushButton(ModeAForm);
        undo_button->setObjectName(QString::fromUtf8("undo_button"));
        undo_button->setGeometry(QRect(140, 470, 101, 51));
        redo_button = new QPushButton(ModeAForm);
        redo_button->setObjectName(QString::fromUtf8("redo_button"));
        redo_button->setGeometry(QRect(540, 470, 101, 51));
    ...
    void retranslateUi(QWidget *ModeAForm)
    {
        ...
        undo_button->setText(QCoreApplication::translate("ModeAForm", "UNDO", nullptr));
        redo_button->setText(QCoreApplication::translate("ModeAForm", "REDO", nullptr));
    } // retranslateUi
